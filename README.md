...
| Elasticsearch 8+ | BM25 关键词索引（需安装 IK 分词插件） | 9200 |
...
**Q: ES 报 "analyzer [ik_smart] has not been configured"？**
A: ES 缺少 IK 中文分词插件。Docker 中手动安装：
```bash
docker compose exec elasticsearch elasticsearch-plugin install https://github.com/medcl/elasticsearch-analysis-ik/releases/download/v8.11.0/elasticsearch-analysis-ik-8.11.0.zip
